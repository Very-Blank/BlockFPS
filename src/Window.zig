...
pub fn init(name: []const u8, width: i32, height: i32) !Self {
...
pub fn setCallbacks(self: *Self) void {
    ...
    _ = glfw.glfwSetFramebufferSizeCallback(self.ptr, framebufferSizeCallback);
...
pub inline fn run(self: *const Self) bool {
...
pub fn swapAndPoll(self: *Self) void {
